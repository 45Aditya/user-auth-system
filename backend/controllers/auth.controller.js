...
import { resetPasswordEmail, sendVerificationEmail, sendResetSuccessEmail } from '../mailtrap/email.js';
...
export const verifyEmail = async (req, res) => {
  ...
  try {
    ...
    if (!user) {
      // Maybe they are already verified?
    ...
    // ✅ If user exists, handle verification here
...
export const resetPassword = async (req, res) => {
  try {
    const { token } = req.params; // fixed here
